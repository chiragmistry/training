sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("sap/trainings/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("sap.trainings.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["sap/trainings/localService/mockserver"], function (mockserver) {
