sap.ui.define([
		...
		return BaseObject.extend("sap.trainings.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias sap.trainings.model.ListSelector
			 */
			 ...
			 * @return {sap.trainings.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
