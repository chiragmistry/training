...
_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("Trainings", { TrainingId: sObjectId });
...
this.getOwnerComponent().oListSelector.clearMasterListSelection();
			...
			var sPath = oElementBinding.getPath(), oResourceBundle = this.getResourceBundle(), oObject = oView.getModel().getObject(sPath), sObjectId = oObject.TrainingId, sObjectName = oObject.ShortDesc, oViewModel = this.getModel("detailView");
