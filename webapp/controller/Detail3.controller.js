...
sap.ui.define([
	...
	return BaseController.extend("sap.trainings.controller.Detail", {
		...
		onListUpdateFinished: function(oEvent) {
			...
			if (this.byId("lineItemsList_copy").getBinding("items").isLengthFinal()) {
				if (iTotalItems) {
					sTitle = iTotalItems; //this.getResourceBundle().getText("detailLineItemTableHeadingCount", [iTotalItems]);
				} else {
		...
		/**
		 *@memberOf sap.mytraining.controller.Detail
		 */
		onRegister: function() {
